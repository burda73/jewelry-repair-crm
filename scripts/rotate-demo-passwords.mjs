...
// Парольная политика проекта требует минимум 6 символов. Берём 20: снижение
// политики — это разрешение вводить простой пароль, а не требование его
// выдавать, поэтому здесь запас прочности сохраняется.
const PASSWORD_LENGTH = 20;

/**
 * Криптостойкий пароль, гарантированно проходящий `passwordSchema`:
 * длина ≥ 6, есть строчная, заглавная и цифра.
 *
