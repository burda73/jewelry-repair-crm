...
export default tseslint.config(
  {
    ignores: [
      ...
      // Локальные артефакты и отладочные скрипты по живому прогону: каталог
      // целиком в .gitignore, в проектный сервис TS он не входит, и линтер
      // спотыкался о него только на машине разработчика.
      '**/.local/**',
    ],
  },
