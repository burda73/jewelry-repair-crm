...
Состояние: **задача 2.1 реализована** (создание партии, состав, лимит). Акт
(2.2), отправка и приём (2.5) — ещё нет, они помечены ниже.
...
| POST | `/batches/:id/act` | Сформировать электронный акт | `logistics:manage` | задача 2.2 |
