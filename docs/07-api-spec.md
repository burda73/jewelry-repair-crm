...
Состояние: **задачи 2.1–2.3 реализованы** (создание партии, состав, лимит,
электронный акт, PDF и подпись сторон). Отправка и приём (2.5) — ещё нет, они
помечены ниже.
...
| POST | `/batches/:id/photos` | Фотофиксация партии | `logistics:manage` | задача 2.4 |
