...
Состояние: **задачи 2.1–2.4 реализованы** (создание партии, состав, лимит,
электронный акт, PDF и подпись сторон, фотофиксация). Отправка и приём (2.5) —
ещё нет, они помечены ниже.
...
### 8.4 Фотофиксация партии (задача 2.4)
