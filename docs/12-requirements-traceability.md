...
| Замечание 3 | Правка прайс-листа в справочниках администратора | `docs/09` 1.4.2–1.4.3, `docs/15` «Дефект 38» | записывающие маршруты прейскуранта + вкладка «Прейскурант» | план: тесты сервиса и контроллера, прогон на живом API |
